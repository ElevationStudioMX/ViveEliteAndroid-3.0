...
public class MainActivity_detalle_producto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbardetalleproducto);
        ...
        if(numero == 1) {
            ...
            list.add(new Model_productos(1, R.drawable.elite_duo, "ELITE DÚO", "Este higiénico con tecnología exclusiva de Minirollo para llevar, el único con el cual aprovechas 100% el rollo de papel higiénico. Tienes un rollo para tu hogar y un mini rollo para llevar."));
            ...
            list.add(new Model_productos(1, R.drawable.elite_diseno_facial, "ELITE DISEÑOS FACIALES", "Ten siempre a la mano pañuelos desechables Elite Línea Diseños los cuales con su doble hoja y exclusiva formulación te darán la mejor combinación entre suavidad y resistencia. Busca los diseños exclusivos y haz más divertida tu decoración en el auto, casa u oficina."));
            list.add(new Model_productos(1, R.drawable.elite_aromas_panuelos, "ELITE AROMAS PAÑUELOS", "Nunca puede faltar la ocasión para sentir y disfrutar la suavidad de los pañuelos Elite Aromas, cuya práctica presentación te permite tenerlos siempre contigo. encuéntralos en diferentes y frescos aromas como sandía, manzana, limón y uva."));
            list.add(new Model_productos(1, R.drawable.elite_spa_panuelos, "ELITE SPA PAÑUELOS", "Disfruta los aromas relajantes que te ofrecen pañuelos Elite Línea Spa en sus diversas presentaciones, los cuales están fabricados bajo los más altos estándares de calidad, que permiten ofrecer suavidad para cuidar tu piel y la de tu familia. Aromas Fresa-Frambuesa, Pera-Manzana, Coco-Piña, Limón-Mandarina."));
            list.add(new Model_productos(1, R.drawable.elite_diseno_panuelos, "ELITE DISEÑOS PAÑUELOS", "Ten siempre a la mano pañuelos desechables Elite Línea Diseños los cuales con su triple hoja y exclusiva formulación te darán la mejor combinación entre suavidad y resistencia. Busca los diseños exclusivos y haz más divertida tu decoración en el auto, casa u oficina."));
            list.add(new Model_productos(1, R.drawable.elite_spa_faciales, "ELITE SPA FACIALES", "Disfruta los aromas relajantes que te ofrecen pañuelos Elite Línea Spa en sus diversas presentaciones, los cuales están fabricados bajo los más altos estándares de calidad, que permiten ofrecer suavidad para cuidar tu piel y la de tu familia. Aromas Fresa-Frambuesa, Pera-Manzana, Coco-Piña, Limón-Mandarina."));
        }

        RecyclerView recyclerView = findViewById(R.id.recicleviwerdetalleproducto);
