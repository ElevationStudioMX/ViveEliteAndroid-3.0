package com.example.helperyoutube;
...
public class YoutubePlayerView extends WebView {
    ...
    public void initialize(String videoId, YouTubeListener youTubeListener) {
       ...
       // set.setUserAgentString("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.117 Safari/537.36");
    ...
    private String getVideoHTML(String videoId) {
        try {
            ...
            if (in != null) {
                ...
                html = html.replace("[AUTO_HIDE]", String.valueOf(params.getAutohide()))
